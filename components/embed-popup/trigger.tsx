      ...
      >
        ...
        <motion.div
          className={cn(
            ...
            !error &&
              isAgentConnecting &&
              '[background-image:conic-gradient(from_0deg,transparent_0%,transparent_30%, #070033_50%,transparent_70%,transparent_100%)] animate-spin',
            (isAgentConnected || (error && popupOpen)) && 'bg-destructive-foreground'
          )}
          style={{
            backgroundColor: !popupOpen && !isAgentConnecting && !error ? ' #070033' : undefined,
          }}
        />
        {/* icon */}
        <div
                ...
                <img
                  src={
                    process.env.NEXT_PUBLIC_WIDGET_URL
                      ? `${process.env.NEXT_PUBLIC_WIDGET_URL}/Agenix_Icon.png`
                      : '/Agenix_Icon.png'
                  }
                  alt="Agenix AI"
