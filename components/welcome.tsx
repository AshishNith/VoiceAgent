    ...
    <div className="text-fg1 mx-auto flex min-h-screen max-w-prose flex-col justify-center py-4 md:py-20">
      <div className="h-[520px] space-y-10 px-4">
        <div className="items-top flex justify-between">
          <h1 className="text-fg0 text-2xl font-bold text-pretty">Agenix AI Livekit Widget</h1>
          {/* <div className="mt-1">
        ...
        <p>
          Embed the Livekit voice assistant into your website or application. Choose between iframe
          or popup integration for a seamless voice AI experience.
        </p>
